%  function dy=Matrix_def3(t,y)  % for shaft with mass, one disc 2 bearings
clear all;
clc;
rho=7800;
E=2.1*10^11;
...
% title('Plot of Disp vs \omega for 2 amb and 1 disc(I amb)','FontSize',12)
...
% title('Plot of Disp vs \omega for 2 amb and 1 disc(II amb)','FontSize',12)
% legend('Without AMB','With AMB')
...
plot(Phase1(2,:),'-r')
 xlabel('\omega (rad/sec)','fontsize',12)
ylabel('Phase \phi')
title('Plot of Phase \phi vs \omega for 2 amb and 1 disc(I amb)','FontSize',12)
legend('Without AMB','With AMB')
...
%  xlabel('\omega (rad/sec)','fontsize',12)
% ylabel('Phase \phi')
% title('Plot of Phase \phi vs \omega for 2 amb and 1 disc(II amb)','FontSize',12)
% legend('Without AMB','With AMB')
